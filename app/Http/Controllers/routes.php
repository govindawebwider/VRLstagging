...
Route::group(['middleware' => ['web']], function () {
	...
	Route::get('edit_video/{video}', 'LoginController@edit_video');
	...
	Route::get('edit_sample_video/{video_id}', 'LoginController@edit_sample_video');
	Route::post('edit_sample_video/{video_id}', 'LoginController@post_edit_sample_video');
	...
	Route::get('panding_requests','LoginController@panding_requests');
	...
	Route::post('payment_dtl','ArtistController@artist_payment_dtl');
...
Route::group(['middleware' => ['web']], function () {
	...
	Route::get('user_change_password','LoginController@user_change_password');
	Route::post('user_change_password','LoginController@post_user_change_password');
...
Route::group(['middleware' => 'web'], function () {
	...
	Route::get('get_video_requests','AdminController@get_video_requests');
        ...
        Route::post('updateReactionStatus','AdminController@update_reaction_video_status');
	...
	//Route::get('forget_pass','AdminController@get_forget_pass');
	//Route::post('forget_pass','AdminController@forgetpass');
	//Route::get('forget_password_verify/{email}','AdminController@forget_password_verify');
	...
	Route::get('/artist_reminder/{artist_id}',function($artist_id){
		...
		if($artist_data!=null){
			...
			return redirect( url()->previous())->with('success',"Successfully Send Reminder to Artist ");
		}else{
			return redirect( url()->previous())->with('error'," Reminder Not Send Successfully ,Artist Not found");
		}
	...
	Route::get('/user_payment_reminder/{user_id}',function($user_id)
	{
		...
		if($user_data!=null){
			...
			return redirect( url()->previous())->with('success',"Successfully Send Reminder to User ");
		}else{
			return redirect( url()->previous())->with('error'," Payment Reminder Not Send Successfully ,User Not found");
		}
	});
