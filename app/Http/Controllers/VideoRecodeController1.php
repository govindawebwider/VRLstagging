...
//
	...
	public function water_mark(Request $request){
		...
		$ffmpegPath = '/usr/local/bin/ffmpeg';
		//$inputPath = '/home/vrl/public_html/public/uploads/8203003861322218.mp4';
		$inputPath = '/home/vrl/public_html/public/uploads/9195493237849289.mp4';
		$watermark = '/home/vrl/public_html/public/vrl_logo.png';
	...
	/*$filePath = 'uploads/45746392525413813.mp4'; 
		$rand = rand(11111,99999).date('U');
			$ffmpegPath = '/usr/local/bin/ffmpeg';
			$inputPath = '/home/vrl/public_html/public/'.$filePath;
			$watermark = '/home/vrl/public_html/public/vrl_logo.png';
