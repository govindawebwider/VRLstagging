...
Route::get('/requested_video/{file}', function($file) {
	$s3 = \Illuminate\Support\Facades\Storage::disk('s3');
	return redirect($s3->url('requested_video/watermark/' . $file));
});
...
Route::get('/review_csv',function ()
{
	$testimonial = App\Testimonial::select('*')->get();
	Excel::create('Review List', function($excel) use($testimonial) {
...
Route::get('Payment', 'PaymentController@AppPayment');
Route::get('/share-percentage', 'PaymentController@getSharePercentage');
Route::post('/share-percentage','PaymentController@updateSharePercentage');
//Route::get('/payment_success_register', 'PaymentController@payment_success_register');
...
Route::post('tested', 'ApiController@test');
...
Route::post('request-video', 'ApiController@requestVideo');
...
Route::post('apiregistration', 'ApiController@userRegistration');
Route::post('apiforget', 'ApiController@forgotPassword');
...
Route::get('list_chart_toppers', 'ApiController@list_chart_toppers');
Route::get('view_latestVideo', 'ApiController@view_latestVideo');
Route::get('api/sliders', 'ApiController@sliders');
Route::get('artist', 'ApiController@artistProfile');
Route::get('get-artist-profile', 'ApiController@getArtistProfile');
Route::post('logout/', 'ApiController@logout');
Route::post('edit-profile', 'ApiController@editProfile');
Route::post('notifictionTest', 'ApiController@notifiction_test');
Route::get('get-profile', [
    'as' => 'get-profile',
    'uses' => 'ApiController@getProfile'
]);
Route::get('get-latest-videos', [
    'as' => 'get-latest-video',
    'uses' => 'ApiController@getArtistLatestVideos'
]);
Route::get('apt-text', 'ApiController@ahptText'); // a-about, h-help, p-privacy, t-term
Route::post('change_pass_api', 'ApiController@changePassword');
Route::get('get/videos/{artist}', [
    'as' => 'get.videos',
    'uses' => 'ApiController@getPendingVideos'
]);
Route::get('get-occasions', 'ApiController@getArtistOccasions');
Route::get('get-occasion-price', 'ApiController@getOccasionPrice');
Route::post('push-notification', 'ApiController@pushNotification');

Route::post('reaction_uploads', 'ApiController@reactionVideoUpload');
Route::post('ReactionVideoList', 'ApiController@reactionVideoList');
Route::post('UserReport', 'ApiController@user_report_against_artist');
Route::get('get-wallet', 'ApiController@getArtistWallet');
Route::get('get-bookings', 'ApiController@getBookings');
Route::post('approve-video', 'ApiController@approveVideoRequest');
Route::post('reject-video', 'ApiController@rejectVideoRequest');
Route::get('get-artist-reviews', 'ApiController@getArtistReviews');
Route::get('get-artist-latest-videos', 'ApiController@getThisArtistLatestVideo');
Route::get('get-related-artists', 'ApiController@getRelatedArtist');
Route::get('user-pending-videos', 'ApiController@getUserApprovedPendingVideos');
Route::get('user-completed-videos', 'ApiController@getUserCompletedVideos');
Route::post('add-video-review', 'ApiController@addVideoReview');
Route::get('user-home-screen', 'ApiController@getUserHomeScreen');
Route::post('edit-artist-profile', 'ApiController@editArtistProfile');
Route::get('edit-artist', 'ApiController@editArtist');
Route::get('get-bank-details', 'ApiController@getBankDetails');
Route::post('update-bank-details', 'ApiController@updateBankDetails');
/*----------------------- Artist Route------------------------------*/

Route::group(['middleware' => ['web']], function () {
	Route::post('/emailupdate', 'ArtistController@emailupdate');
	Route::get('/emailreset/{token}', 'ArtistController@emailreset');
	Route::get('/successMessage', 'ArtistController@successMessage');
	...
	Route::get('artist/delete-completed-requests/{req_id}','ArtistController@deleteCompletedRequest')->name('artist.deleteCompletedRequests');
    ...
    Route::post('joinus-request', 'LoginController@register');
    Route::get('validate-email', 'LoginController@validate_email');
	...
	Route::get('download_requ_video/{video}', 'LoginController@download_requ_video');
	...
	Route::get('view_review', 'LoginController@view_review');
	...
	Route::get('delete_review/{testi_id}', 'LoginController@delete_review');
	...
	Route::post('reject_request', 'LoginController@reject_request');
	Route::get('occasions/index', 'OccasionController@index');
	Route::get('occasions/create', 'OccasionController@create');
	Route::post('occasions/store', 'OccasionController@store');
	Route::get('occasions/edit/{id}', 'OccasionController@edit');
	Route::post('occasions/update', 'OccasionController@update');
	Route::get('occasions/get-price', 'OccasionController@getOccasionPrice');
	Route::get('occasions/delete/{id}','OccasionController@delete');
	...
	Route::post('upload_requested_video', 'LoginController@upload_requestedVideo');
        Route::patch('webcame/upload-requested-video-web-cam', 'LoginController@upload_requested_vide_via_web_cam')->name('webCamUpload');
	...
	Route::get('export-payments', 'ArtistController@artist_payment_detail_export')->name('export-payments');
	...
	Route::get('forget_password_verify','LoginController@forget_password_verify');
	...
	Route::get('add_about','AdminController@addAbout');
	Route::post('add_about','AdminController@postAddAbout');
	Route::get('add_terms','AdminController@addTerms');
	Route::post('add_terms','AdminController@postAddTerms');
	Route::get('add_privacy','AdminController@addPrivacy');
	Route::post('add_privacy','AdminController@postAddPrivacy');

	Route::get('test','ArtistController@test');
	Route::get('recaptha','LoginController@recaptha');
	
	Route::get('stripe_payment','LoginController@stripe_payment');
	Route::post('stripe_payment','LoginController@post_stripe_payment');

	Route::get('add_help','AdminController@addHelp');
	Route::post('add_help','AdminController@postAddHelp');
	
	Route::get('webcame/{id}','LoginController@webcame');
	Route::get('webcam_video_upload','AdminController@video_upload');
	Route::get('show_review/{testimonial_id}','ArtistController@show_review');
	Route::get('hide_review/{testimonial_id}','ArtistController@hide_review');
...
Route::group(['middleware' => ['web']], function () {
	...
	Route::get('/search_artist','ArtistController@searchArtist');
	...
	Route::post('user_change_password','UserController@post_user_change_password');
        Route::get('userAccount/reaction-upload','UserController@userReactionVideos');
        Route::post('userAccount/videoUpload','UserController@videoUpload');
        Route::get('userAccount/view-reaction','UserController@viewReactionUpload');  
        
        Route::post('reaction_video_uplaod','UserController@ReactionVideoUpload');  
...
Route::group(['middleware' => 'web'], function () {
	Route::post('create_category','CategoryController@post_create_category');
	Route::get('create_category','CategoryController@create_category');
	Route::get('edit_category/{id}','CategoryController@get_edit_category');
	Route::post('edit_cat','CategoryController@edit_category');
	Route::get('delete_category/{id}','CategoryController@delete_category');
	Route::get('view_categories_list/{id}','CategoryController@view_categories_list');
	Route::post('list/categories/view','CategoryController@view_categories_list');
	Route::get('disable_category/{category_id}','CategoryController@disable_category');
	Route::get('categories','CategoryController@category_list');
	Route::get('enable_category/{category_id}','CategoryController@enable_category');
	...
	Route::get('joinus-artist','AdminController@joinUsArtist');
	Route::get('confirm-joinus-artist/{id}','AdminController@confirmjoinUsArtist');
	Route::get('deny-joinus-artist/{id}','AdminController@denyjoinUsArtist');

	Route::get('enable_chart_topper/{artist_id}','AdminController@enable_chart_topper');
	Route::get('disable_chart_topper/{artist_id}','AdminController@disable_chart_topper');
	
	Route::get('invite_artist','AdminController@invite_artist');
	Route::post('invite_artist','AdminController@post_invite_artist');
	Route::get('add_admin_review','AdminController@add_admin_review');
	...
	Route::get('approve_review/{testimonial_id}','AdminController@approve_review');
	Route::get('reject_review/{testimonial_id}','AdminController@reject_review');
	...
	Route::get('set_home/{testimonial_id}','AdminController@set_home');
	Route::get('hide_home/{testimonial_id}','AdminController@hide_home');
	Route::get('set_artist/{testimonial_id}','AdminController@set_artist');
	Route::get('hide_artist/{testimonial_id}','AdminController@hide_artist');

	Route::get('admin_view_video/{id}','AdminController@admin_view_video');
	Route::get('edit_admin_review/{testimonial_id}','AdminController@get_admin_review');
	Route::get('del_admin_review/{testimonial_id}','AdminController@del_admin_review');
	...
	Route::get('getReactionVideoRequests','AdminController@get_reaction_video_requests');
	Route::get('SocialMediaVideos','AdminController@get_twitter_reaction_video');
        Route::get('twitterUserTimeLine', 'TwitterController@twitterUserTimeLine');
	Route::get('updateReactionStatus/{id}/{status}','AdminController@update_reaction_video_status');
	...
	Route::get('user_dashboard','LoginController@post_user_dashboard');
	...
	Route::get('/report', 'AdminController@report_against_artist');
	Route::get('user_status/{user_id}', 'ApiController@user_status');

	Route::get('/fulfil_reminder_to_artist/{artist_id}/{request_id}','AdminController@fulfilReminderToArtist')->middleware('auth');
        
	Route::get('/artist_reminder/{artist_id}/{request_id}',function($artist_id, $request_id){
		...
		if($artist_data!=null){
            ...
            Mail::send('emails.artist_reminder', $confirmation_code, function ($m) use ($artist_data, $confirmation_code) {
			...
			return redirect( url()->previous())->with('error'," Reminder not Sent, Artist not found");
		}
...
//			//dd($confirmation_code);
			...
			return redirect( url()->previous())->with('error'," Payment reminder not sent, user not found");
		}
	});
        
        
        Route::get('cronjob/send-requests-on-delivary-date','CronjobController@sendRequestVideoOnDelivaryDate');
...
Route::get('payapp', 'PaymentController@payapp');
//});
...
Route::group(['middleware' => ['web']], function () {
	...
	//start new path
	Route::get('/booking_checkout','HomeController@booking_checkout');
	//ends new path
	...
	Route::get('video_detail/{id}', array('as' => 'videoDetails', 'uses' => 'HomeController@video_detail_page'))->middleware('auth');
 ...
 * Routes Description : Leaving A reviews for the artists and sending messages for the senders 
 * 
 */
    Route::get('/reviews/create','ReviewController@create');
    Route::post('/reviews/store',['uses'=>'ReviewController@store','as'=>'storeReview']);
    
    
       /* -- Email Address Update Request -- */
        Route::get('artist/checkEmailAddress/{email}','ArtistController@checkEmailAddress');
        Route::get('artist/checkPassword/{password}','ArtistController@checkPassword');
        Route::post('artist/new-email-address-request','ArtistController@updateEmailAddressRequest');

        Route::get('update/confirm-email-change','ArtistController@confirmUpdateEmailAddress')->name('updateEmailPage');
        Route::post('update/update-email-address','ArtistController@updateEmailAddress')->name('updateEmailAdress');
