			...
			<nav class="navbar">
			  <div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
					...
					<?php
					$results = DB::select('select * from setting where id = :id', ['id' => 1]);
					//print_r($results[0]->status);
					?>
					      @if($results[0]->status!='hide')

			              <li>
			              	<a data-toggle="modal" data-target="#exampleModalCenterJOIN" class="btn loginshadow navbar-btn joinus">
							Join Us
						    </a>
					     </li>
					     @endif
			            ...
			            <div class="login-body">
				            <div class="row">
				                ...
				                <div class="col-sm-10 paddingtop">
										...
										<div class="field">
											<input readonly="" type="text" name="date_of_birth" id="date_of_birth"  placeholder="mm/dd/yyyy"
												   onfocus="this.placeholder = ''"
