                          ...
                          <i class="arrow"></i> </span>
                                <ul>
                                    @if(session('current_type') == 'Artist')
                                        <li><a href="{{URL('switch_as_admin')}}"><i class="icon icon-users"></i>
                                                <span>Switch to Admin</span></a>
                                        </li>
                                    @endif
                                    <li class="{{ Request::is('ProfileUpdate') ? 'active' : '' }}">
                                        <a href="{{ URL($artist->profile_url)}}"> <i class="icon icon-users"></i>
                                            <span>view Profile</span>
                                        </a>
                                    </li>
                                    <li class="{{ Request::is('ProfileUpdate') ? 'active' : '' }}">
                                        <a href="{{URL('ProfileUpdate')}}"> <i class="icon icon-users"></i>
                                            <span>Edit Profile</span>
                                        </a>
                                    </li>
                                    <li class="{{ Request::is('change-password') ? 'active' : '' }}"><a
                                                href="{{URL('change-password')}}"> <i class="icon icon-lock"></i>
                                            <span>Change Password</span>
                                        </a></li>
                                    <li class="{{ Request::is('getLogout') ? 'active' : '' }}">
                                        <a href="{{ URL::route('getLogout') }}"> <i class="icon icon-exit"></i>
                                            <span>Logout</span>
                                        </a>
                                    </li>
                                </ul>
            ...
            <div class="col-md-12 ">
                <div id="page-wrapper">
                    <div class="graphs">
                        ...
                        {!! Form::open(['url' => 'occasions/update', 'class'=> 'form form-horizontal text-left', 'method' => 'post']) !!}
                        <div class="inner-wrap">
                            ...
                            <div class="form-group">
                                ...
                                <div class="control-box">
                                    <input type="text" name="price" id="social_url" value="{{$occasion->price}}"
                                           class='form-control'>
                            ...
                            <input type="hidden" name="artist_profile_id" value="{{$occasion->artist_profile_id}}">
