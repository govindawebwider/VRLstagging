          ...
          <div class="graphs">
            ...
            <div class="form-group">
              ...
              <div class="control-box">
                ...
                <button class="btn btn-primary center-block req_record_button" id="req_record_button">Start Recording</button>
              </div>
            </div>
          </h2>
          <div class="form-group">
...
//              + recordingMedia.innerHTML;
              ...
              function makeXMLHttpRequest(url, data, callback) {
                ...
                /*request.onreadystatechange = function() {
                    if (request.readyState == 4 && request.status == 200) {
                        ...
                        window.location = base_url+"/video_requests";
                  ...
                  request.onreadystatechange = function() {
                    ...
                    request.upload.onprogress = function(event) {
                      callback('Upload Progress ' + Math.round(event.loaded / event.total * 100) + "%  please wait ....." );
                    };
  ...
  <script type="text/javascript">
    $( document ).ready(function() {
      ...
      var fewSeconds = 17;
        //var fewSeconds = 2;
        $("#req_record_button").click(function() {
          var btn = $(this);
          $(this).hide();
          setTimeout(function(){
            btn.show();
