              ...
              <tbody>
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td align="center" valign="top" style="font-family:Helvetica;height:100%;margin:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;width:100%" height="100%" width="100%"><table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin:0px;max-width:600px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;width:100%;table-layout:auto" width="100%">
                      ...
                      <tbody>
                       ...
                       <tr>
                         ...
                         <td  colspan="3" style="padding:25px 20px 15px 20px;"> 
                          ...
                          <h2 style="margin:10px 0 15px;font-weight:600">Verify Your Email Address</h2>

                          <h4 style="padding-bottom:0;margin:0;font-weight:600">Thanks for creating an account with the VRL.</h4>
                      ...
                      <tr>
                       ...
                       <td width="25%" style="padding:5px 20px;"><strong>Username</strong></td>

                       <td width="6%"><strong>:</strong></td>

                       <td width="69%" style="padding:5px 10px;">{{ $email }}</td>
                    ...
                    <tr>
                     ...
                     <td colspan="3" style="padding:5px 20px 5px 20px;"><p style="line-height:22px;">Please follow the link below to verify your email address<br>

                      { URL::to('verify_user/' . $confirmation_code) }}</p>
                  ...
                  <tr>
                   ...
                   <td colspan="3" style="padding:5px 20px 25px 20px;"> <p style="line-height:22px;padding:0;margin:0">Administrator<br>

                    Video Request Line | https://www.videorequestline.com/ | Request for User Registration</p></td>
