                  ...
                  <td align="center" valign="top" style="font-family:Helvetica;height:100%;margin:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;width:100%" height="100%" width="100%"><table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin:0px;max-width:600px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;width:100%;table-layout:auto" width="100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center" valign="top" style="margin:0;max-width:600px;padding-top:50px;padding-right:0;padding-bottom:30px;padding-left:0;width:100%" height="100%" width="100%">

                          <h2 style="margin-bottom:0;">Successfully Register with the VRL</h2>

                          <div>

                            <p style=" font-size:14px; line-height:20px;margin-top: 10px;">Thanks for creating an account with the VRL.<br>
                        ...
                        <tr align="center">
                          ...
                          <td><b>Your Login Credentials</b></td>
                        ...
                        <tr>
                          ...
                          <td align="center">
                            ...
                            <ul style="display:inline-block;margin: 10px auto 30px;font-size:13px;padding:0;  text-align: left;">

                              <li style="list-style: none;padding:0;margin:0 0 5px 0;"><b>User Name : </b>{{$email}}</li>

                              <li style="list-style: none;padding:0;margin:0;"><b>Password : </b>{{$password}}</li>
                    ...
                    <td align="center" valign="top" style="font-family:Helvetica;height:100%;margin:0;;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;width:100%" height="100%" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td align="center" valign="top" style="margin:0;max-width:600px;padding-top:10px;padding-right:0;padding-bottom:10px;padding-left:0;width:100%; font-size:12px;" height="100%" width="100%"><p>© <?php echo date("Y"); ?> Video Request Line</p></td>
