          ...
          <tr>
            <td><table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" style="border-collapse:collapse;font-family:Helvetica;height:100%;margin:0px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;width:600px;background-color:rgb(255,255,255);table-layout:auto;border: solid 2px #b135cd;" bgcolor="#ffffff">
              <tbody>
                ...
                <tr>
                  <td align="center" valign="top" style="font-family:Helvetica;height:100%;margin:0;padding-top:30px;padding-right:0;padding-bottom:50px;padding-left:0;width:100%" height="100%" width="100%"><table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin:0px;max-width:600px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;width:100%;table-layout:auto" width="100%">
                    <tbody>
                     <tr align="left">
                       <td colspan="3" style="padding:5px 20px;"> <h3>Request Details are following</h3>
                            <p>Your VRL order number is {{ $identifier }}</p>
                       </td>
                     </tr> 

                     {{--<tr>--}}
                       {{--<td style="padding:5px 20px;">Artist</td>--}}
                       {{--<td width="8%"><strong>:</strong></td>--}}
                       {{--<td width="51%" style="padding:5px 10px;">{{$artist}}</td>--}}
                     {{--</tr>--}}
                     <tr>
                       <td style="padding:5px 20px;">Price </td>
                       <td width="8%"><strong>:</strong></td>
                       <td width="51%" style="padding:5px 10px;  text-decoration: line-through; color:red">{{$request_detail->ReqVideoPrice}}</td>
                     </tr>
                     <tr>
                         <td style="padding:5px 20px;">Sender Name</td>
                         <td width="8%"><strong>:</strong></td>
                         <td width="51%" style="padding:5px 10px;  text-decoration: line-through; color:red">{{ $requester_name }}</td>
                     </tr>
                     <tr>
                         <td style="padding:5px 20px;">Sender Email</td>
                         <td width="8%"><strong>:</strong></td>
                         <td width="51%" style="padding:5px 10px;  text-decoration: line-through; color:red">{{ $requester_email }}</td>
                     </tr>
                     <tr>
                         <td style="padding:5px 20px;">Recipient Name</td>
                         <td width="8%"><strong>:</strong></td>
                         <td width="51%" style="padding:5px 10px;  text-decoration: line-through; color:red">{{ $recipient_name }}</td>
                     </tr>
                     <tr>
                         <td style="padding:5px 20px;">Recipient Email</td>
                         <td width="8%"><strong>:</strong></td>
                         <td width="51%" style="padding:5px 10px;  text-decoration: line-through; color:red">{{ $recipient_email }}</td>
                     </tr>
                     @if($songName != null)
                         <tr>
                     ...
                     <tr>
                       ...
                       <td width="8%"><strong>:</strong></td>
                       <td width="51%" style="padding:5px 10px;">{{$request_detail->Title}}</td>
                     </tr>

                     <tr>
                       <td style="padding:5px 20px;">Personlized Message</td>
                       <td><strong>:</strong></td>
                       <td style="padding:5px 10px;">{{$request_detail->Description}}</td>
                     </tr>
                     ...
                     <tr align="left">
                       <td colspan="3" style="padding:5px 20px;"> <p>This is an automated email generated from our server. For customer support, please email support@videorequestline.com.
</p></td>
                     </tr>
