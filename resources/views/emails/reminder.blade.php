                      ...
                      <tr>
                        ...
                        <td align="center" valign="top" style="margin:0;max-width:600px;padding-top:30px;padding-right:0;padding-bottom:30px;padding-left:0;width:100%" height="100%" width="100%">
                          ...
                          <div>
                            ...
                            <p style="line-height:22px;">Thank you for creating an account with Video Request Line. Click on the Verify Account button below to complete the signup process.
</p>
