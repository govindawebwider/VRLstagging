      ...
      <table cellpadding="0" cellspacing="0" border="0" align="center" style="border-collapse:collapse; table-layout:auto;">
    	...
    	<tr>
				...
				<tr>
                   ...
                   <p> {{ $data->reciever_name }} Sent you a message to your Personalized Video Gift.
</p>
<hr>
                   </td>
	...
	<tr>
                   <td colspan="3" style="padding:0 20px 5px 20px;">
                	<p>{{ $data->message_to_sender }}</p>
                   <hr>
                   
                   <p>
                   To view the video, login to your account at videorequestline.com and select on my videos.
</p>
                   </td>
				...
				<tr>
                   <td colspan="3" style="padding:0 20px 5px 20px;">
                   <p>This is an automated email generated from our server. For customer support, please email support@videorequestline.com.
                 ...
                 <tr>
                   ...
                   <td colspan="3" style="padding:5px 20px 25px 20px;"> 
                       <a href="http://videorequestline.com">
                           http://videorequestline.com
                       </a>
                   </td>
