                ...
                <tr>
                  ...
                  <td align="center" valign="top" style="font-family:Helvetica;height:100%;margin:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;width:100%" height="100%" width="100%"><table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin:0px;max-width:600px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;width:100%;table-layout:auto" width="100%">
                    ...
                    <tbody>
                     ...
                     <tr>
                       ...
                       <td  colspan="3" style="padding:25px 20px 15px 20px;"> 
                        ...
                        <h2 style="margin:10px 0 15px;font-weight:600">Thank You For Requesting New Video</h2>

                        <h4 style="padding-bottom:0;margin:0;font-weight:600"> Please Login to Check Status</h4>
                   ...
                   <tr>
                     ...
                     <td colspan="3" style="padding:5px 20px;"><p>Thanks <b> {{$name}}</b> for Requesting New video.</p></td>
                   ...
                   <tr>
                    ...
                    <td style="padding:5px 20px;"><strong>Video Title</strong></td>
                  ...
                  <tr>
                   ...
                   <td style="padding:5px 20px;"><strong>Video Description</strong></td>
                 ...
                 <tr>
                   ...
                   <td style="padding:5px 20px;"><strong>Video Status</strong></td>
                 ...
                 <tr>
                   ...
                   <td style="padding:5px 20px;"><strong>Video Delivery Date</strong></td>

                   <td><strong>:</strong></td>

                   <td style="padding:5px 10px;">{{$video_delivery_time}}</td>
                 ...
                 <tr>
                   ...
                   <td  colspan="3" style="padding:25px 20px 5px 20px;">Once your request is approved you will be notified for payment.</td>
