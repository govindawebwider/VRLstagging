              ...
              <tbody>
                ...
                <tr>
                  <td align="center" valign="top" style="font-family:Helvetica;height:100%;margin:0;padding-top:30px;padding-right:0;padding-bottom:50px;padding-left:0;width:100%" height="100%" width="100%"><table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin:0px;max-width:600px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;width:100%;table-layout:auto" width="100%">
                    <tbody>
                     <tr align="left">
                       <td colspan="3" style="padding:5px 20px;"> <h2>Your payment has been refunded successfully.</h2></td>
                     </tr>

                     <tr align="left">
                       <td colspan="2" style="padding:5px 20px;"> <h2>Details:</h2></td>
                     </tr> 

                     <tr>
                       <td style="padding:5px 20px;">Refunded</td>
                       <td width="8%"><strong>:</strong></td>
                       <td width="51%" style="padding:5px 10px;">Time Exceed</td>
                     </tr>
                     <tr>
                       <td style="padding:5px 20px;">Price </td>
                       <td width="8%"><strong>:</strong></td>
                       <td width="51%" style="padding:5px 10px;">{{$request_detail->ReqVideoPrice}}</td>
                     </tr>

 <tr>
                       <td style="padding:5px 20px;">To</td>
                       <td width="8%"><strong>:</strong></td>
                       <td width="51%" style="padding:5px 10px;">{{$user}}</td>
                     </tr>
 <tr>
                       <td style="padding:5px 20px;">From</td>
                       <td width="8%"><strong>:</strong></td>
                       <td width="51%" style="padding:5px 10px;">{{$name}}</td>
                     </tr>
{{$name}}
                     ...
                     <tr>
                       <td style="padding:5px 20px;">Video Request Date</td>
                       <td><strong>:</strong></td>
                       <td style="padding:5px 10px;">{{$request_detail->created_at}}</td>
                     </tr> 
                     
                     <tr>
                       <td style="padding:5px 20px;">Video Request Completion</td>
                       <td><strong>:</strong></td>
