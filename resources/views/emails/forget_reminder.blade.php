...
<head>
    <meta charset="utf-8">
    <title>{{\Lang::get('messages.vrl_forgot_password')}}</title>
</head>
<body>
                        ...
                        <tr>
                            <td align="center" valign="top"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td align="center" valign="top"
                                            style="margin:0;max-width:600px;padding-top:30px;padding-right:0;padding-bottom:30px;padding-left:0;width:100%"
                                            height="100%" width="100%">
                                            <h2>{{\Lang::get('messages.reset_your_account_password')}}</h2>
                                            <div>
                                                <p style="line-height:22px;">{{\Lang::get('messages.follow_link_to_reset_password')}}</p>
                                                <p>{{\Lang::get('messages.click_btn_to_reset_password')}} </p>
                                                <p>
                                                    <a href="{{URL('forget_password_verify?userToken='.$confirmation_code )}}"
                                                       target="_blank"
                                                       style="background:#222;padding:5px 10px;color:#fff;border-radius:3px;text-decoration:none;font-weight:normal;margin-top:20px;">{{\Lang::get('views.reset')}}</a>
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin:0px;margin-bottom:0px;max-width:600px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;width:100%;table-layout:auto; background:#b135cd; color:#fff;" bgcolor="#b135cd" width="100%">
                                    ...
                                    <tr>
                                        <td align="center" valign="top"
                                            ...
                                            height="100%" width="100%" style="padding:10px;">
                                                <p>
                                                    {{\Lang::get('messages.copy_right_vrl')}}
                                                </p>
                                        </td>
                                    </tr>
                                    </tbody>
